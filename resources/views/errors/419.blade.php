...
@section('title', 'Sesión Expirada - OnubaBus')

@section('content')
    <section class="py-16 bg-white">
        <div class="max-w-md mx-auto bg-white shadow-lg rounded-lg p-8 text-center">
            <div class="mb-6">
                <h2 class="text-3xl font-bold text-gray-800 mb-2">419</h2>
                <h3 class="text-xl font-semibold text-gray-700 mb-4">Sesión Expirada</h3>
            </div>

            <p class="text-gray-600 mb-6">
                Tu sesión ha expirado por motivos de seguridad. Por favor, actualiza la página e intenta nuevamente.
            </p>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-500">
                    Este error ocurre cuando el formulario ha estado abierto demasiado tiempo
                </p>
            </div>
        </div>
    </section>
